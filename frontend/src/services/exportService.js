...
<head>
  ...
  <title>TED Style English Learning Material</title>
  <style>
    /* TED 主题样式 */
    :root {
      --ted-red: #E62B1E;
    ...
    * {
    ...
    .ted-section-title .en {
      font-family: var(--font-en);
    }

    .ted-section-title .zh {
    ...
    .bilingual-content.single-en {
      grid-template-columns: 100%;
    }

    .bilingual-content.single-zh {
      grid-template-columns: 100%;
    }
    ...
    .chinese-column {
      ...
      color: var(--ted-gray);
      padding-left: 30px;
      border-left: 3px solid var(--ted-light);
    }
    ...
    .ted-table tbody tr,
    .ted-content table tbody tr,
    table tbody tr {
      border-bottom: 1px solid #E5E5E5;
      transition: background 0.2s;
    }

    .ted-table tbody tr:nth-child(even),
    .ted-content table tbody tr:nth-child(even),
    table tbody tr:nth-child(even) {
      background: var(--ted-light);
    }

    .ted-table tbody tr:hover,
    .ted-content table tbody tr:hover,
    table tbody tr:hover {
      background: #FFE6E6;
    }

    .ted-table td,
    .ted-content table td,
    table td {
      padding: 14px 20px;
      font-size: 15px;
      line-height: 1.6;
    ...
    .ted-content table td:first-child,
    ...
    /* 可折叠卡片 */
    .collapsible-card {
      border: 2px solid var(--ted-light);
      border-radius: 12px;
      margin-bottom: 20px;
      overflow: hidden;
      transition: all 0.3s;
    ...
    .ted-content pre code {
      background: transparent;
      color: var(--ted-white);
      padding: 0;
    }

    .ted-content blockquote {
    ...
    @media (max-width: 768px) {
      ...
      .chinese-column {
        padding-left: 0;
        border-left: none;
        border-top: 3px solid var(--ted-light);
        padding-top: 25px;
      }
